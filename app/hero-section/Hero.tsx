        ...
        >
          ...
          >
            <Image
              src={profile}
              priority
              alt="Ayush's headshot"
              data-blobity-tooltip="Sigma Boy"
      ...
      >
        ...
        >
          <p className="z-50 text-center text-[16px] font-medium text-[#e4ded7] md:text-[20px] lg:text-left">
            Fullstack Engineer and Web Designer, Network Engineer at{" "}
            <Link
              href="https://indibus.net/"
              target="_blank"
        ...
        >
          <p className="text-right text-[16px] font-semibold text-[#e4ded7] md:text-[20px]">
            Focused on interfaces and experiences, working remotely from Ghaziabad,
            India.
          </p>
        </motion.div>
      </div>
